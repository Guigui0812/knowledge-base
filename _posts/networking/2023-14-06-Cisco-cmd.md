...
|`access-list <number> permit <ip>`|Creates an access-list that permits the IP address|
|`access-list <number> deny <ip>`|Creates an access-list that denies the IP address|
|`show access-lists`|Prints the access-lists|
|`ip access-list standard <name>`|Creates a standard access-list|
|`ip access-list extended <name>`|Creates an extended access-list|
|`permit <ip>`|Permits the IP address in acl configuration mode (after `ip access-list <standard>extended> <name>`)|
|`deny <ip>`|Denies the IP address in acl configuration mode (after `ip access-list <standard/extended> <name>`)|
